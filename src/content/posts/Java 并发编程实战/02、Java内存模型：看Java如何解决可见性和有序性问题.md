...
pubDate: 2024-01-01
categories: ['Java']
description: 02、Java内存模型：看Java如何解决可见性和有序性问题
---
...
<audio><source src="https://static001.geekbang.org/resource/audio/4e/a9/4e47fabe747154115d55f37975b4bea9.mp3" type="audio/mpeg"></audio>
...
![](<https://static001.geekbang.org/resource/image/b1/e1/b1fa541e98c74bc2a033d9ac5ae7fbe1.png?wh=1142*640>)

<center><span class="reference">示例代码中的传递性规则</span></center>
...
3. [JSR-133: Java<sup>TM</sup>

 Memory Model and Thread Specification](<https://www.cs.umd.edu/~pugh/java/memoryModel/jsr133.pdf>)

<!-- -->

[[01、可见性、原子性和有序性问题：并发编程Bug的源头 |上一章]] <-> [[03、互斥锁（上）：解决原子性问题 |下一章]]
