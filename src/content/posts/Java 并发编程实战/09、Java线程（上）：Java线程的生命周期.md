...
pubDate: 2024-01-01
categories: ['Java']
description: 09、Java线程（上）：Java线程的生命周期
---
...
<audio><source src="https://static001.geekbang.org/resource/audio/fa/0d/fac0721d577fefc74de980b361682b0d.mp3" type="audio/mpeg"></audio>
...
![](<https://static001.geekbang.org/resource/image/9b/e5/9bbc6fa7fb4d631484aa953626cf6ae5.png?wh=1142*714>)

<center><span class="reference">通用线程状态转换图——五态模型</span></center>
...
<center><span class="reference">Java中的线程状态转换图</span></center>
...
![](<https://static001.geekbang.org/resource/image/67/be/67734e1a062adc7cf7baac7d6c17ddbe.png?wh=650*532>)

<center><span class="reference">发生死锁的线程栈</span></center>
...
[[08、管程：并发编程的万能钥匙|prev]] <-> [[10、Java线程（中）：创建多少线程才是合适的？|next]]