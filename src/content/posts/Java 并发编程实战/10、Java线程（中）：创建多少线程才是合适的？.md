...
pubDate: 2024-01-01
categories: ['Java']
description: 10、Java线程（中）：创建多少线程才是合适的？
---
...
![](<https://static001.geekbang.org/resource/image/98/b9/98dbaa0e34f9082e929fbbf7a08a93b9.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/b7/93/b7454829f207e4fce7fc42b40ae66b93.mp3" type="audio/mpeg"></audio>
...
<center><span class="reference">单线程执行示意图</span></center>
...
<center><span class="reference">二线程执行示意图</span></center>
...
<center><span class="reference">多核执行多线程示意图</span></center>
...
<center><span class="reference">三线程执行示意图</span></center>
...
[[09、Java线程（上）：Java线程的生命周期|prev]] ↔ [[11、Java线程（下）：为什么局部变量是线程安全的？|next]]