...
pubDate: 2024-01-01
categories: ['Java']
description: 11、Java线程（下）：为什么局部变量是线程安全的？
---
...
![](<https://static001.geekbang.org/resource/image/bb/4e/bbbcfe66e76c61e14a94caf96bf3674e.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/db/29/db68790283e75fd25877579cad982129.mp3" type="audio/mpeg"></audio>
...
![](<https://static001.geekbang.org/resource/image/9b/1f/9bd881b545e1c67142486f6594dc9d1f.png?wh=1142*741>)

<center><span class="reference">方法的调用过程</span></center>
...
![](<https://static001.geekbang.org/resource/image/67/c7/674bb47feccbf55cf0b6acc5c92e4fc7.png?wh=1142*571>)

<center><span class="reference">调用栈结构</span></center>
...
![](<https://static001.geekbang.org/resource/image/ec/9c/ece8c32d23e4777c370f594c97762a9c.png?wh=1142*571>)

<center><span class="reference">保护局部变量的调用栈结构</span></center>
...
![](<https://static001.geekbang.org/resource/image/84/1a/840cb955e521bd51776dbcdad3dba11a.png?wh=1142*571>)

<center><span class="reference">线程与调用栈的关系图</span></center>
...
[[10、Java线程（中）：创建多少线程才是合适的？|prev]] ↔ [[12、如何用面向对象思想写好并发程序？|next]]