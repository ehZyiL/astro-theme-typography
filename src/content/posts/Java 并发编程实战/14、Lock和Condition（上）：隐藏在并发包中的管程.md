...
pubDate: 2024-01-01
categories: ['Java']
description: 14、Lock和Condition（上）：隐藏在并发包中的管程
---
...
<audio><source src="https://static001.geekbang.org/resource/audio/e5/0e/e5795555e9b590061872a008bce13f0e.mp3" type="audio/mpeg"></audio>
...
[[13、理论基础模块热点问题答疑|prev]] ↔ [[15、Lock和Condition（下）：Dubbo如何用管程实现异步转同步？|next]]
