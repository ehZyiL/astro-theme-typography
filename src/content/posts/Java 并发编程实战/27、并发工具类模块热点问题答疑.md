...
![](<https://static001.geekbang.org/resource/image/6a/a4/6a1efaa5b5d50571cbdfbd356f9d80a4.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/6a/4e/6a0bcaf7adc8d254862b78395270bf4e.mp3" type="audio/mpeg"></audio>
...
[[14、Lock和Condition（上）：隐藏在并发包中的管程]]的思考题，本意是通过破坏不可抢占条件来避免死锁问题，但是它的实现中有一个致命的问题，那就是： while(true) 没有break条件，从而导致了死循环。除此之外，这个实现虽然不存在死锁问题，但还是存在活锁问题的，解决活锁问题很简单，只需要随机等待一小段时间就可以了。
