...
pubDate: 2024-01-01
categories: ['Java']
description: 39、案例分析（二）：高性能网络应用框架Netty
---
...
![](<https://static001.geekbang.org/resource/image/8b/66/8bbaab9f6ee4dac70a6aa7f060239a66.jpg>)

![音频](https://static001.geekbang.org/resource/audio/06/85/068c0e218368700a2bc4befb300b2985.mp3)
...
<center><span class="reference">BIO的线程模型</span></center>
...
<center><span class="reference">理想的线程模型图</span></center>
...
<center><span class="reference">Reactor模式类结构图</span></center>
...
<center><span class="reference">Netty中的线程模型</span></center>
