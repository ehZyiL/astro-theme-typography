...
pubDate: 2024-01-01
categories: ['Java']
description: 第17讲、一个线程两次调用start()方法会出现什么情况？
---
...
![](<https://static001.geekbang.org/resource/image/50/6f/5075173000d99ffca5ab684c5530186f.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/8d/94/8deca6c623d51354ba32124922a06d94.mp3" type="audio/mpeg"></audio>

今天我们来深入聊聊线程，相信大家对于线程这个概念都不陌生，它是Java并发的基础元素，理解、操纵、诊断线程是Java工程师的必修课，但是你真的掌握线程了吗？

今天我要问你的问题是，<span class="orange">一个线程两次调用start()方法会出现什么情况？谈谈线程的生命周期和状态转移。</span>
