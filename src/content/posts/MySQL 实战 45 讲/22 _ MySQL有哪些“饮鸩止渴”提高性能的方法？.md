---
title: 22 _ MySQL有哪些“饮鸩止渴”提高性能的方法？
pubDate: 2024-01-01
categories: ['MySQL']
description: 22 _ MySQL有哪些“饮鸩止渴”提高性能的方法？
---
...
<audio><source src="https://static001.geekbang.org/resource/audio/fe/b0/fecb446f3d865de1ff925bfaadae40b0.mp3" type="audio/mpeg"></audio>
...
![](<https://static001.geekbang.org/resource/image/90/2a/9091ff280592c8c68665771b1516c62a.png?wh=1246*234>)

<center><span class="reference">图1 sleep线程的两种状态</span></center>
...
![](<https://static001.geekbang.org/resource/image/ae/25/ae6a9ceecf8517e47f9ebfc565f0f925.png?wh=1022*157>)

<center><span class="reference">图2 sleep线程的两种状态，show processlist结果</span></center>

图中id=4和id=5的两个会话都是Sleep 状态。而要看事务具体状态的话，你可以查information\_schema库的innodb\_trx表。

![](<https://static001.geekbang.org/resource/image/ca/e8/ca4b455c8eacbf32b98d1fe9ed9876e8.png?wh=755*682>)

<center><span class="reference">图3 从information_schema.innodb_trx查询事务状态</span></center>
...
> 使用 query_rewrite 需要先安装插件

```mysql
mysql > source D:\Chen\develop\tools\mysql-8.0.31-winx64\share\install_rewriter.sql
```
...
![](<https://static001.geekbang.org/resource/image/47/8a/47a1002cbc4c05c74841591d20f7388a.png?wh=1734*385>)

<center><span class="reference">图4 查询重写效果</span></center>
...
![](<https://static001.geekbang.org/resource/image/3a/1e/3a7578e104612a188a2d574eaa3bd81e.png?wh=942*270>)<br>
