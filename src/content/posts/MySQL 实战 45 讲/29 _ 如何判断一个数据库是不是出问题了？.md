---
title: 29 _ 如何判断一个数据库是不是出问题了？
pubDate: 2024-01-01
categories: ['MySQL']
description: 29 _ 如何判断一个数据库是不是出问题了？
---
...
<audio><source src="https://static001.geekbang.org/resource/audio/52/06/52d50a49a19d6b835388715a0c0b5506.mp3" type="audio/mpeg"></audio>
...
![](<https://static001.geekbang.org/resource/image/35/55/35076dd3d0a0d44d22b76d2a29885255.png?wh=932*290>)

<center><span class="reference">图1 查询blocked</span></center>
...
![](<https://static001.geekbang.org/resource/image/32/1d/3206ea18b8a24b546515b1b95dc4a11d.png?wh=1142*856>)

<center><span class="reference">图2 系统锁死状态（假设等行锁的语句占用并发计数）</span></center>
...
![](<https://static001.geekbang.org/resource/image/75/dd/752ccfe43b4eab155be17401838c62dd.png?wh=1535*641>)

<center><span class="reference">图3 performance_schema.file_summary_by_event_name的一行</span></center>
