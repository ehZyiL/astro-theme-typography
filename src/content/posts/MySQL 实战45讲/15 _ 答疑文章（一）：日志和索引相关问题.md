---
title: 15 _ 答疑文章（一）：日志和索引相关问题
pubDate: 2024-01-01
categories: ['MySQL']
description: 15 _ 答疑文章（一）：日志和索引相关问题
---
...
<audio><source src="https://static001.geekbang.org/resource/audio/d8/11/d8b9e7666aec71d6114fab11773abb11.mp3" type="audio/mpeg"></audio>
...
![](<https://static001.geekbang.org/resource/image/ee/2a/ee9af616e05e4b853eba27048351f62a.jpg?wh=1142*1522>)

<center><span class="reference">图1 两阶段提交示意图</span></center>
...
2. 如果redo log里面的事务只有完整的prepare，则判断对应的事务binlog是否存在并完整：<br>
...
![](<https://static001.geekbang.org/resource/image/eb/63/eb838b87e9c20fa00aca50ef154f2a63.jpg?wh=1142*856>)

<center><span class="reference">图2 只用binlog支持崩溃恢复</span></center>
...
![](<https://static001.geekbang.org/resource/image/c4/ed/c45063baf1ae521bf5d98b6d7c0e0ced.png?wh=1248*694>)

<center><span class="reference">图3 并发“喜欢”逻辑操作顺序</span></center>
...
> 值是1的时候，表示user\_id 关注 liker\_id;<br>
> 
>  值是2的时候，表示liker\_id 关注 user\_id;<br>
> 
>  值是3的时候，表示互相关注。
...
![](<https://static001.geekbang.org/resource/image/36/70/367b3f299b94353f32f75ea825391170.png?wh=691*103>)<br>
...
> 并发系统性能的角度考虑，应该先插入操作记录，再更新计数表。<br>
> 
...
> @北天魔狼、@斜面镜子 Bil 和@Bin 等同学，都给出了正确答案；<br>
> 
