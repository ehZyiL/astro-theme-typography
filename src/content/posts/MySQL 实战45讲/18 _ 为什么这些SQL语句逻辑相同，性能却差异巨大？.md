---
title: 18 _ 为什么这些SQL语句逻辑相同，性能却差异巨大？
pubDate: 2024-01-01
categories: ['MySQL']
description: 18 _ 为什么这些SQL语句逻辑相同，性能却差异巨大？
---
...
<audio><source src="https://static001.geekbang.org/resource/audio/79/46/79eb1abbbbbbdf2ade89fc4156b34d46.mp3" type="audio/mpeg"></audio>
...
假设你现在维护了一个交易系统，其中交易记录表`tradelog`包含交易流水号（tradeid）、交易员id（operator）、交易时间（t\_modified）等字段。为了便于描述，我们先忽略其他字段。这个表的建表语句如下：
...
![](<https://static001.geekbang.org/resource/image/3e/86/3e30d9a5e67f711f5af2e2599e800286.png?wh=1142*856>)

<center><span class="reference">图1 t_modified索引示意图</span></center>
...
![](<https://static001.geekbang.org/resource/image/27/55/27c2f5ff3549b18ba37a28f4919f3655.png?wh=1637*143>)

<center><span class="reference">图2 explain 结果</span></center>
...
![](<https://static001.geekbang.org/resource/image/2b/14/2b67fc38f1651e2622fe21d49950b214.png?wh=289*142>)

<center><span class="reference">图3 MySQL中字符串和数字转换的效果示意图</span></center>
...
![](<https://static001.geekbang.org/resource/image/ad/22/adfe464af1d15f3261b710a806c0fa22.png?wh=1412*171>)

<center><span class="reference">图4 语句Q1的explain 结果</span></center>
...
![](<https://static001.geekbang.org/resource/image/82/a9/8289c184c8529acea0269a7460dc62a9.png?wh=1142*856>)

<center><span class="reference">图5 语句Q1的执行过程</span></center>
...
![](<https://static001.geekbang.org/resource/image/92/11/92cb498ceb3557e41700fae53ce9bd11.png?wh=1328*194>)

<center><span class="reference">图6 explain 结果</span></center>
...
![](<https://static001.geekbang.org/resource/image/aa/d6/aa844a7bf35d330b9ec96fc159331bd6.png?wh=1332*187>)

<center>图7 SQL语句优化后的explain结果</center>
...
> @老杨同志 提出了重新整理的方法、@雪中鼠[悠闲] 提到了用rowid的方法，是类似的思路，就是让表里面保存一个无空洞的自增值，这样就可以用我们的随机算法1来实现；<br>
> 
