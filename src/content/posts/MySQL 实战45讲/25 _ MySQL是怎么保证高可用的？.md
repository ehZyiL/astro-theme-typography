---
title: 25 _ MySQL是怎么保证高可用的？
pubDate: 2024-01-01
categories: ['MySQL']
description: 25 _ MySQL是怎么保证高可用的？
---
...
<audio><source src="https://static001.geekbang.org/resource/audio/e9/f4/e93751889d44c375c248416ab07dedf4.mp3" type="audio/mpeg"></audio>
...
![](<https://static001.geekbang.org/resource/image/89/cc/89290bbcf454ff9a3dc5de42a85a69cc.png?wh=1142*880>)

<center><span class="reference">图 1 MySQL主备切换流程--双M结构</span></center>
...
2. 备库取出当前**正在执行的事务的时间字段的值，计算它与当前系统时间的差值**，得到`seconds_behind_master`。

<!-- -->

可以看到，其实`seconds_behind_master`这个参数计算的就是T3-T1。所以，我们可以用`seconds_behind_master`来作为主备延迟的值，这个值的时间精度是秒。
...
![](<https://static001.geekbang.org/resource/image/54/4a/54f4c7c31e6f0f807c2ab77f78c8844a.png?wh=1142*880>)

<center><span class="reference">图2 MySQL可靠性优先主备切换流程</span></center>
...
![](<https://static001.geekbang.org/resource/image/37/3a/3786bd6ad37faa34aca25bf1a1d8af3a.png?wh=1142*880>)

<center><span class="reference">图3 可用性优先策略，且binlog_format=mixed</span></center>
...
![](<https://static001.geekbang.org/resource/image/b8/43/b8d2229b2b40dd087fd3b111d1bdda43.png?wh=1142*880>)

<center><span class="reference">图4 可用性优先策略，且binlog_format=row</span></center>
...
![](<https://static001.geekbang.org/resource/image/55/8b/553b7fc2d0dce3ec78bb595e1806eb8b.png?wh=1142*880>)

<center><span class="reference">图5 可靠性优先策略，主库不可用</span></center>
...
![](<https://static001.geekbang.org/resource/image/cf/71/cf5ea52aa3b26ef56c567125197fa171.png?wh=1142*880>)

<center><span class="reference">图6 备库延迟</span></center>
...
![](<https://static001.geekbang.org/resource/image/f9/71/f968192ce2f436c939dd702b8f409771.png?wh=1142*880>)

<center><span class="reference">图7 三节点循环复制</span></center>
