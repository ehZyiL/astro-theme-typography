---
title: 36 _ 为什么临时表可以重名？
pubDate: 2024-01-01
categories: ['MySQL']
description: 36 _ 为什么临时表可以重名？
---
...
![](<https://static001.geekbang.org/resource/image/9e/60/9e21a3bfe9b0741720115bdafb2e8b60.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/2a/51/2a58b00b42c4ad537d0f8a42b9b6f151.mp3" type="audio/mpeg"></audio>

<span class="orange">今天是大年三十，在开始我们今天的学习之前，我要先和你道一声春节快乐！</span>
...
![](<https://static001.geekbang.org/resource/image/3c/e3/3cbb2843ef9a84ee582330fb1bd0d6e3.png?wh=934*631>)

<center><span class="reference">图1 临时表特性示例</span></center>
...
由于不用担心线程之间的重名冲突，临时表经常会被用在复杂查询的优化过程中。其中，**分库分表系统的跨库查询**就是一个典型的使用场景。

一般分库分表的场景，就是要把一个逻辑上的大表分散到不同的数据库实例上。比如。将一个大表ht，按照字段f，拆分成1024个分表，然后分布到32个数据库实例上。如下图所示：

![](<https://static001.geekbang.org/resource/image/dd/81/ddb9c43526dfd9b9a3e6f8c153478181.jpg?wh=1142*880>)

<center><span class="reference">图2 分库分表简图</span></center>
...
<center><span class="reference">图3 跨库查询流程示意图</span></center>
...
<center><span class="reference">图4 临时表的表名</span></center>
...
<center><span class="reference">图5 主备关系中的临时表操作</span></center>
...
<center><span class="reference">图6 关于临时表改名的思考题</span></center>
